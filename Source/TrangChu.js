    ...
    return (
        <SafeAreaView style={{flex:1 , backgroundColor:'#00008B'}}>
            ...
            <View style={{flex:'1',top:'30px', alignItems:'center'}}>
                ...
                <Text style={{color:'white', fontSize:'29px', top:'10px',textTransform:'uppercase'}}>{user}</Text>
                <Text style={{color:'white', fontSize:'20px',top:'20px' , lineHeight:'23px'}}>Tài khoản của tôi</Text>
                <View style={{width:'350px',marginLeft:'30px',marginRight:'30px',height:'50px',backgroundColor:'white',marginTop:'50px',borderRadius:'5 px'}}>
                    <View style={{marginLeft:'20px'}}>
                        <Text style={{fontSize:'18px',fontWeight:'bold'}}>Tài Khoản Nguồn</Text>
                        <Text style={{fontSize:'17px',color:'darkblue'}}>1.000.000 VND</Text>
                    </View>
                </View>
            </View>
